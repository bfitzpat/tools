...
import org.jboss.tools.switchyard.model.spring.Output;
 ...
 * <ul>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getAop <em>Aop</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getAggregate <em>Aggregate</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getBean <em>Bean</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getDoCatch <em>Do Catch</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getWhen <em>When</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getChoice <em>Choice</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getOtherwise <em>Otherwise</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getConvertBodyTo <em>Convert Body To</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getDelay <em>Delay</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getDynamicRouter <em>Dynamic Router</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getEnrich <em>Enrich</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getFilter <em>Filter</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getDoFinally <em>Do Finally</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getIdempotentConsumer <em>Idempotent Consumer</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getInOnly <em>In Only</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getInOut <em>In Out</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getIntercept <em>Intercept</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getInterceptFrom <em>Intercept From</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getInterceptToEndpoint <em>Intercept To Endpoint</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getLoadBalance <em>Load Balance</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getLog <em>Log</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getLoop <em>Loop</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getMarshal <em>Marshal</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getMulticast <em>Multicast</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getOnCompletion <em>On Completion</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getOnException <em>On Exception</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getPipeline <em>Pipeline</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getPolicy <em>Policy</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getPollEnrich <em>Poll Enrich</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getProcess <em>Process</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getRecipientList <em>Recipient List</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getRemoveHeader <em>Remove Header</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getRemoveHeaders <em>Remove Headers</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getRemoveProperty <em>Remove Property</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getResequence <em>Resequence</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getRollback <em>Rollback</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getRoute <em>Route</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getRoutingSlip <em>Routing Slip</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getSample <em>Sample</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getSetBody <em>Set Body</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getSetExchangePattern <em>Set Exchange Pattern</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getSetFaultBody <em>Set Fault Body</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getSetHeader <em>Set Header</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getSetOutHeader <em>Set Out Header</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getSetProperty <em>Set Property</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getSort <em>Sort</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getSplit <em>Split</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getStop <em>Stop</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getThreads <em>Threads</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getThrottle <em>Throttle</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getThrowException <em>Throw Exception</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getTo <em>To</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getTransacted <em>Transacted</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getTransform <em>Transform</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getDoTry <em>Do Try</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getUnmarshal <em>Unmarshal</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getValidate <em>Validate</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getWireTap <em>Wire Tap</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OutputImpl#getAnyAttribute1 <em>Any Attribute1</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
