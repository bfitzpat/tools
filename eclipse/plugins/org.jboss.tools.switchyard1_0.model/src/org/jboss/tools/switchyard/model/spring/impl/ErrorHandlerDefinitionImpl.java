...
import org.jboss.tools.switchyard.model.spring.ErrorHandlerType;
 ...
 * <ul>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ErrorHandlerDefinitionImpl#getRedeliveryPolicy <em>Redelivery Policy</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ErrorHandlerDefinitionImpl#getDeadLetterUri <em>Dead Letter Uri</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ErrorHandlerDefinitionImpl#getExecutorServiceRef <em>Executor Service Ref</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ErrorHandlerDefinitionImpl#getLevel <em>Level</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ErrorHandlerDefinitionImpl#getLogName <em>Log Name</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ErrorHandlerDefinitionImpl#getOnRedeliveryRef <em>On Redelivery Ref</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ErrorHandlerDefinitionImpl#getRedeliveryPolicyRef <em>Redelivery Policy Ref</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ErrorHandlerDefinitionImpl#getRetryWhileRef <em>Retry While Ref</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ErrorHandlerDefinitionImpl#getTransactionManagerRef <em>Transaction Manager Ref</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ErrorHandlerDefinitionImpl#getTransactionTemplateRef <em>Transaction Template Ref</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ErrorHandlerDefinitionImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ErrorHandlerDefinitionImpl#isUseOriginalMessage <em>Use Original Message</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
