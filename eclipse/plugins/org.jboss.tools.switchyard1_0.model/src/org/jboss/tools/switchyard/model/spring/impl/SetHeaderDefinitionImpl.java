...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Set Header Definition</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.SetHeaderDefinitionImpl#getHeaderName <em>Header Name</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.SetHeaderDefinitionImpl#getAnyAttribute3 <em>Any Attribute3</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SetHeaderDefinitionImpl extends NoOutputExpressionNodeImpl implements SetHeaderDefinition {
	/**
	 ...
	 * @generated
	 */
	protected SetHeaderDefinitionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SpringPackage.eINSTANCE.getSetHeaderDefinition();
	}
	...
	public void setHeaderName(String newHeaderName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpringPackage.SET_HEADER_DEFINITION__HEADER_NAME, oldHeaderName, headerName));
	}
	...
	public FeatureMap getAnyAttribute3() {
		if (anyAttribute3 == null) {
			anyAttribute3 = new BasicFeatureMap(this, SpringPackage.SET_HEADER_DEFINITION__ANY_ATTRIBUTE3);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SpringPackage.SET_HEADER_DEFINITION__ANY_ATTRIBUTE3:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SpringPackage.SET_HEADER_DEFINITION__HEADER_NAME:
