 ...
 * <ul>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.OtherwiseDefinitionImpl#getAnyAttribute2 <em>Any Attribute2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OtherwiseDefinitionImpl extends OutputImpl implements OtherwiseDefinition {
	/**
	...
	protected EClass eStaticClass() {
		return SpringPackage.eINSTANCE.getOtherwiseDefinition();
	}
	...
	public FeatureMap getAnyAttribute2() {
		if (anyAttribute2 == null) {
			anyAttribute2 = new BasicFeatureMap(this, SpringPackage.OTHERWISE_DEFINITION__ANY_ATTRIBUTE2);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SpringPackage.OTHERWISE_DEFINITION__ANY_ATTRIBUTE2:
