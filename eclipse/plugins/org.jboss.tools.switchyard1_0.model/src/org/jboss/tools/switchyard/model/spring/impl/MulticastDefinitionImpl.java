 ...
 * <ul>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.MulticastDefinitionImpl#getExecutorServiceRef <em>Executor Service Ref</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.MulticastDefinitionImpl#getOnPrepareRef <em>On Prepare Ref</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.MulticastDefinitionImpl#isParallelProcessing <em>Parallel Processing</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.MulticastDefinitionImpl#isShareUnitOfWork <em>Share Unit Of Work</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.MulticastDefinitionImpl#isStopOnException <em>Stop On Exception</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.MulticastDefinitionImpl#getStrategyRef <em>Strategy Ref</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.MulticastDefinitionImpl#isStreaming <em>Streaming</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.MulticastDefinitionImpl#getTimeout <em>Timeout</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.MulticastDefinitionImpl#getAnyAttribute2 <em>Any Attribute2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MulticastDefinitionImpl extends OutputImpl implements MulticastDefinition {
	...
	protected EClass eStaticClass() {
		return SpringPackage.eINSTANCE.getMulticastDefinition();
	}
	...
	public void setExecutorServiceRef(String newExecutorServiceRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpringPackage.MULTICAST_DEFINITION__EXECUTOR_SERVICE_REF, oldExecutorServiceRef, executorServiceRef));
	}
	...
	public void setOnPrepareRef(String newOnPrepareRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpringPackage.MULTICAST_DEFINITION__ON_PREPARE_REF, oldOnPrepareRef, onPrepareRef));
	}
	...
	public void setParallelProcessing(boolean newParallelProcessing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpringPackage.MULTICAST_DEFINITION__PARALLEL_PROCESSING, oldParallelProcessing, parallelProcessing, !oldParallelProcessingESet));
	}
	...
	public void unsetParallelProcessing() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, SpringPackage.MULTICAST_DEFINITION__PARALLEL_PROCESSING, oldParallelProcessing, PARALLEL_PROCESSING_EDEFAULT, oldParallelProcessingESet));
	}
	...
	public void setShareUnitOfWork(boolean newShareUnitOfWork) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpringPackage.MULTICAST_DEFINITION__SHARE_UNIT_OF_WORK, oldShareUnitOfWork, shareUnitOfWork, !oldShareUnitOfWorkESet));
	}
	...
	public void unsetShareUnitOfWork() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, SpringPackage.MULTICAST_DEFINITION__SHARE_UNIT_OF_WORK, oldShareUnitOfWork, SHARE_UNIT_OF_WORK_EDEFAULT, oldShareUnitOfWorkESet));
	}
	...
	public void setStopOnException(boolean newStopOnException) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpringPackage.MULTICAST_DEFINITION__STOP_ON_EXCEPTION, oldStopOnException, stopOnException, !oldStopOnExceptionESet));
	}
	...
	public void unsetStopOnException() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, SpringPackage.MULTICAST_DEFINITION__STOP_ON_EXCEPTION, oldStopOnException, STOP_ON_EXCEPTION_EDEFAULT, oldStopOnExceptionESet));
	}
	...
	public void setStrategyRef(String newStrategyRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpringPackage.MULTICAST_DEFINITION__STRATEGY_REF, oldStrategyRef, strategyRef));
	}
	...
	public void setStreaming(boolean newStreaming) {
		...
		streamingESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpringPackage.MULTICAST_DEFINITION__STREAMING, oldStreaming, streaming, !oldStreamingESet));
	}
	...
	public void unsetStreaming() {
		...
		streamingESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, SpringPackage.MULTICAST_DEFINITION__STREAMING, oldStreaming, STREAMING_EDEFAULT, oldStreamingESet));
	}
	...
	public void setTimeout(long newTimeout) {
		...
		timeoutESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpringPackage.MULTICAST_DEFINITION__TIMEOUT, oldTimeout, timeout, !oldTimeoutESet));
	}
	...
	public void unsetTimeout() {
		...
		timeoutESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, SpringPackage.MULTICAST_DEFINITION__TIMEOUT, oldTimeout, TIMEOUT_EDEFAULT, oldTimeoutESet));
	}
	...
	public FeatureMap getAnyAttribute2() {
		if (anyAttribute2 == null) {
			anyAttribute2 = new BasicFeatureMap(this, SpringPackage.MULTICAST_DEFINITION__ANY_ATTRIBUTE2);
		}
