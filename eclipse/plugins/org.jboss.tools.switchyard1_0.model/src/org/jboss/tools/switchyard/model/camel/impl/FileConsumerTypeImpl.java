...
import org.jboss.tools.switchyard.model.camel.FileConsumerType;
 ...
 * <ul>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#getInitialDelay <em>Initial Delay</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#getDelay <em>Delay</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#isUseFixedDelay <em>Use Fixed Delay</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#isRecursive <em>Recursive</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#isDelete <em>Delete</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#isNoop <em>Noop</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#getPreMove <em>Pre Move</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#getMove <em>Move</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#getMoveFailed <em>Move Failed</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#getInclude <em>Include</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#getExclude <em>Exclude</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#isIdempotent <em>Idempotent</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#getIdempotentRepository <em>Idempotent Repository</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#getInProgressRepository <em>In Progress Repository</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#getFilter <em>Filter</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#getSorter <em>Sorter</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#getSortBy <em>Sort By</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#getReadLock <em>Read Lock</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#getReadLockTimeout <em>Read Lock Timeout</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#getReadLockCheckInterval <em>Read Lock Check Interval</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#getExclusiveReadLockStrategy <em>Exclusive Read Lock Strategy</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#getProcessStrategy <em>Process Strategy</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#getMaxMessagesPerPoll <em>Max Messages Per Poll</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#isStartingDirectoryMustExist <em>Starting Directory Must Exist</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#isDirectoryMustExist <em>Directory Must Exist</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileConsumerTypeImpl#getDoneFileName <em>Done File Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
