...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Routing Slip Definition</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RoutingSlipDefinitionImpl#isIgnoreInvalidEndpoints <em>Ignore Invalid Endpoints</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RoutingSlipDefinitionImpl#getUriDelimiter <em>Uri Delimiter</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RoutingSlipDefinitionImpl#getAnyAttribute3 <em>Any Attribute3</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RoutingSlipDefinitionImpl extends NoOutputExpressionNodeImpl implements RoutingSlipDefinition {
	/**
	 ...
	 * @generated
	 */
	protected RoutingSlipDefinitionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SpringPackage.eINSTANCE.getRoutingSlipDefinition();
	}
	...
	public void setIgnoreInvalidEndpoints(boolean newIgnoreInvalidEndpoints) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpringPackage.ROUTING_SLIP_DEFINITION__IGNORE_INVALID_ENDPOINTS, oldIgnoreInvalidEndpoints, ignoreInvalidEndpoints, !oldIgnoreInvalidEndpointsESet));
	}
	...
	public void unsetIgnoreInvalidEndpoints() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, SpringPackage.ROUTING_SLIP_DEFINITION__IGNORE_INVALID_ENDPOINTS, oldIgnoreInvalidEndpoints, IGNORE_INVALID_ENDPOINTS_EDEFAULT, oldIgnoreInvalidEndpointsESet));
	}
	...
	public void setUriDelimiter(String newUriDelimiter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpringPackage.ROUTING_SLIP_DEFINITION__URI_DELIMITER, oldUriDelimiter, uriDelimiter));
	}
	...
	public FeatureMap getAnyAttribute3() {
		if (anyAttribute3 == null) {
			anyAttribute3 = new BasicFeatureMap(this, SpringPackage.ROUTING_SLIP_DEFINITION__ANY_ATTRIBUTE3);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SpringPackage.ROUTING_SLIP_DEFINITION__ANY_ATTRIBUTE3:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SpringPackage.ROUTING_SLIP_DEFINITION__IGNORE_INVALID_ENDPOINTS:
				return isIgnoreInvalidEndpoints();
			case SpringPackage.ROUTING_SLIP_DEFINITION__URI_DELIMITER:
