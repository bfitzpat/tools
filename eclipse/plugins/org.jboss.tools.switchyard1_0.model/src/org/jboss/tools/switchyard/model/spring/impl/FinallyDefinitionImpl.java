 ...
 * <ul>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.FinallyDefinitionImpl#getAnyAttribute2 <em>Any Attribute2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FinallyDefinitionImpl extends OutputImpl implements FinallyDefinition {
	...
	protected EClass eStaticClass() {
		return SpringPackage.eINSTANCE.getFinallyDefinition();
	}
	...
	public FeatureMap getAnyAttribute2() {
		if (anyAttribute2 == null) {
			anyAttribute2 = new BasicFeatureMap(this, SpringPackage.FINALLY_DEFINITION__ANY_ATTRIBUTE2);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SpringPackage.FINALLY_DEFINITION__ANY_ATTRIBUTE2:
