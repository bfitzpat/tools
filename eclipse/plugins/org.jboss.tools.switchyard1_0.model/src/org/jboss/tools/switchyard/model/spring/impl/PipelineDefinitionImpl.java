 ...
 * <ul>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.PipelineDefinitionImpl#getAnyAttribute2 <em>Any Attribute2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PipelineDefinitionImpl extends OutputImpl implements PipelineDefinition {
	/**
	...
	protected EClass eStaticClass() {
		return SpringPackage.eINSTANCE.getPipelineDefinition();
	}
	...
	public FeatureMap getAnyAttribute2() {
		if (anyAttribute2 == null) {
			anyAttribute2 = new BasicFeatureMap(this, SpringPackage.PIPELINE_DEFINITION__ANY_ATTRIBUTE2);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SpringPackage.PIPELINE_DEFINITION__ANY_ATTRIBUTE2:
