 ...
 * <ul>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.SimpleExpressionImpl#getResultType <em>Result Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SimpleExpressionImpl extends ExpressionImpl implements SimpleExpression {
	...
	protected EClass eStaticClass() {
		return SpringPackage.eINSTANCE.getSimpleExpression();
	}
	...
	public void setResultType(String newResultType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpringPackage.SIMPLE_EXPRESSION__RESULT_TYPE, oldResultType, resultType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SpringPackage.SIMPLE_EXPRESSION__RESULT_TYPE:
