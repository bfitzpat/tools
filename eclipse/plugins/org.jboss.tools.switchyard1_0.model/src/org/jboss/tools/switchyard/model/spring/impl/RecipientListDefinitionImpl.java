 ...
 * <ul>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RecipientListDefinitionImpl#getDelimiter <em>Delimiter</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RecipientListDefinitionImpl#getExecutorServiceRef <em>Executor Service Ref</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RecipientListDefinitionImpl#isIgnoreInvalidEndpoints <em>Ignore Invalid Endpoints</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RecipientListDefinitionImpl#getOnPrepareRef <em>On Prepare Ref</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RecipientListDefinitionImpl#isParallelProcessing <em>Parallel Processing</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RecipientListDefinitionImpl#isShareUnitOfWork <em>Share Unit Of Work</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RecipientListDefinitionImpl#isStopOnException <em>Stop On Exception</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RecipientListDefinitionImpl#getStrategyRef <em>Strategy Ref</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RecipientListDefinitionImpl#isStreaming <em>Streaming</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RecipientListDefinitionImpl#getTimeout <em>Timeout</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RecipientListDefinitionImpl#getAnyAttribute3 <em>Any Attribute3</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
