...
import org.jboss.tools.switchyard.model.spring.ExpressionNode;
 ...
 * <ul>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getExpressionDefinition <em>Expression Definition</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getConstant <em>Constant</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getEl <em>El</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getGroovy <em>Groovy</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getHeader <em>Header</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getJxpath <em>Jxpath</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getJavaScript <em>Java Script</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getMethod <em>Method</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getMvel <em>Mvel</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getOgnl <em>Ognl</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getPhp <em>Php</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getPython <em>Python</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getRuby <em>Ruby</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getSimple <em>Simple</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getSpel <em>Spel</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getSql <em>Sql</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getTokenize <em>Tokenize</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getXpath <em>Xpath</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getXquery <em>Xquery</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getAop <em>Aop</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getAggregate <em>Aggregate</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getBean <em>Bean</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getDoCatch <em>Do Catch</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getWhen <em>When</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getChoice <em>Choice</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getOtherwise <em>Otherwise</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getConvertBodyTo <em>Convert Body To</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getDelay <em>Delay</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getDynamicRouter <em>Dynamic Router</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getEnrich <em>Enrich</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getFilter <em>Filter</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getDoFinally <em>Do Finally</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getIdempotentConsumer <em>Idempotent Consumer</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getInOnly <em>In Only</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getInOut <em>In Out</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getIntercept <em>Intercept</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getInterceptFrom <em>Intercept From</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getInterceptToEndpoint <em>Intercept To Endpoint</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getLoadBalance <em>Load Balance</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getLog <em>Log</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getLoop <em>Loop</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getMarshal <em>Marshal</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getMulticast <em>Multicast</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getOnCompletion <em>On Completion</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getOnException <em>On Exception</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getPipeline <em>Pipeline</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getPolicy <em>Policy</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getPollEnrich <em>Poll Enrich</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getProcess <em>Process</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getRecipientList <em>Recipient List</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getRemoveHeader <em>Remove Header</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getRemoveHeaders <em>Remove Headers</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getRemoveProperty <em>Remove Property</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getResequence <em>Resequence</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getRollback <em>Rollback</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getRoute <em>Route</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getRoutingSlip <em>Routing Slip</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getSample <em>Sample</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getSetBody <em>Set Body</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getSetExchangePattern <em>Set Exchange Pattern</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getSetFaultBody <em>Set Fault Body</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getSetHeader <em>Set Header</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getSetOutHeader <em>Set Out Header</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getSetProperty <em>Set Property</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getSort <em>Sort</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getSplit <em>Split</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getStop <em>Stop</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getThreads <em>Threads</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getThrottle <em>Throttle</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getThrowException <em>Throw Exception</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getTo <em>To</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getTransacted <em>Transacted</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getTransform <em>Transform</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getDoTry <em>Do Try</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getUnmarshal <em>Unmarshal</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getValidate <em>Validate</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getWireTap <em>Wire Tap</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.ExpressionNodeImpl#getAnyAttribute1 <em>Any Attribute1</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
