...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Stop Definition</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.StopDefinitionImpl#getAnyAttribute2 <em>Any Attribute2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class StopDefinitionImpl extends NoOutputDefinitionImpl implements StopDefinition {
	/**
	...
	protected EClass eStaticClass() {
		return SpringPackage.eINSTANCE.getStopDefinition();
	}
	...
	public FeatureMap getAnyAttribute2() {
		if (anyAttribute2 == null) {
			anyAttribute2 = new BasicFeatureMap(this, SpringPackage.STOP_DEFINITION__ANY_ATTRIBUTE2);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SpringPackage.STOP_DEFINITION__ANY_ATTRIBUTE2:
