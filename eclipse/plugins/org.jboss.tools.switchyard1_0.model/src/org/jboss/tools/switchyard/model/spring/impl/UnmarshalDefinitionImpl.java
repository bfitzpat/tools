 ...
 * <ul>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getBindy <em>Bindy</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getCastor <em>Castor</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getCrypto <em>Crypto</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getCsv <em>Csv</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getCustom <em>Custom</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getFlatpack <em>Flatpack</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getGzip <em>Gzip</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getHl7 <em>Hl7</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getJaxb <em>Jaxb</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getJibx <em>Jibx</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getJson <em>Json</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getProtobuf <em>Protobuf</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getRss <em>Rss</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getSecureXML <em>Secure XML</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getSerialization <em>Serialization</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getSoapjaxb <em>Soapjaxb</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getString <em>String</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getSyslog <em>Syslog</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getTidyMarkup <em>Tidy Markup</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getXmlBeans <em>Xml Beans</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getXstream <em>Xstream</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getZip <em>Zip</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.UnmarshalDefinitionImpl#getAnyAttribute2 <em>Any Attribute2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
