...
import org.jboss.tools.switchyard.model.camel.FileProducerType;

/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>File Producer Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileProducerTypeImpl#getFileExist <em>File Exist</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileProducerTypeImpl#getTempPrefix <em>Temp Prefix</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileProducerTypeImpl#getTempFileName <em>Temp File Name</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileProducerTypeImpl#isKeepLastModified <em>Keep Last Modified</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileProducerTypeImpl#isEagerDeleteTargetFile <em>Eager Delete Target File</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.camel.impl.FileProducerTypeImpl#getDoneFileName <em>Done File Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FileProducerTypeImpl extends EObjectImpl implements FileProducerType {
	...
	protected EClass eStaticClass() {
		return CamelPackage.Literals.FILE_PRODUCER_TYPE;
	}
	...
	public void setFileExist(String newFileExist) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.FILE_PRODUCER_TYPE__FILE_EXIST, oldFileExist, fileExist));
	}
	...
	public void setTempPrefix(String newTempPrefix) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.FILE_PRODUCER_TYPE__TEMP_PREFIX, oldTempPrefix, tempPrefix));
	}
	...
	public void setTempFileName(String newTempFileName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.FILE_PRODUCER_TYPE__TEMP_FILE_NAME, oldTempFileName, tempFileName));
	}
	...
	public void setKeepLastModified(boolean newKeepLastModified) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.FILE_PRODUCER_TYPE__KEEP_LAST_MODIFIED, oldKeepLastModified, keepLastModified, !oldKeepLastModifiedESet));
	}
	...
	public void unsetKeepLastModified() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CamelPackage.FILE_PRODUCER_TYPE__KEEP_LAST_MODIFIED, oldKeepLastModified, KEEP_LAST_MODIFIED_EDEFAULT, oldKeepLastModifiedESet));
	}
	...
	public void setEagerDeleteTargetFile(boolean newEagerDeleteTargetFile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.FILE_PRODUCER_TYPE__EAGER_DELETE_TARGET_FILE, oldEagerDeleteTargetFile, eagerDeleteTargetFile, !oldEagerDeleteTargetFileESet));
	}
	...
	public void unsetEagerDeleteTargetFile() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CamelPackage.FILE_PRODUCER_TYPE__EAGER_DELETE_TARGET_FILE, oldEagerDeleteTargetFile, EAGER_DELETE_TARGET_FILE_EDEFAULT, oldEagerDeleteTargetFileESet));
	}
	...
	public void setDoneFileName(String newDoneFileName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CamelPackage.FILE_PRODUCER_TYPE__DONE_FILE_NAME, oldDoneFileName, doneFileName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CamelPackage.FILE_PRODUCER_TYPE__FILE_EXIST:
				return getFileExist();
			case CamelPackage.FILE_PRODUCER_TYPE__TEMP_PREFIX:
				return getTempPrefix();
			case CamelPackage.FILE_PRODUCER_TYPE__TEMP_FILE_NAME:
				return getTempFileName();
			case CamelPackage.FILE_PRODUCER_TYPE__KEEP_LAST_MODIFIED:
				return isKeepLastModified();
			case CamelPackage.FILE_PRODUCER_TYPE__EAGER_DELETE_TARGET_FILE:
				return isEagerDeleteTargetFile();
			case CamelPackage.FILE_PRODUCER_TYPE__DONE_FILE_NAME:
