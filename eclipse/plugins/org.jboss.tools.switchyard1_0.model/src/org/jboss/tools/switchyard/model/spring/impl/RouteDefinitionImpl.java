...
import org.jboss.tools.switchyard.model.spring.ShutdownRoute;
import org.jboss.tools.switchyard.model.spring.ShutdownRunningTask;
 ...
 * <ul>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getFrom <em>From</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getAop <em>Aop</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getAggregate <em>Aggregate</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getBean <em>Bean</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getDoCatch <em>Do Catch</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getWhen <em>When</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getChoice <em>Choice</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getOtherwise <em>Otherwise</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getConvertBodyTo <em>Convert Body To</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getDelay <em>Delay</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getDynamicRouter <em>Dynamic Router</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getEnrich <em>Enrich</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getFilter <em>Filter</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getDoFinally <em>Do Finally</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getIdempotentConsumer <em>Idempotent Consumer</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getInOnly <em>In Only</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getInOut <em>In Out</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getIntercept <em>Intercept</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getInterceptFrom <em>Intercept From</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getInterceptToEndpoint <em>Intercept To Endpoint</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getLoadBalance <em>Load Balance</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getLog <em>Log</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getLoop <em>Loop</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getMarshal <em>Marshal</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getMulticast <em>Multicast</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getOnCompletion <em>On Completion</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getOnException <em>On Exception</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getPipeline <em>Pipeline</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getPolicy <em>Policy</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getPollEnrich <em>Poll Enrich</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getProcess <em>Process</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getRecipientList <em>Recipient List</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getRemoveHeader <em>Remove Header</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getRemoveHeaders <em>Remove Headers</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getRemoveProperty <em>Remove Property</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getResequence <em>Resequence</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getRollback <em>Rollback</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getRoute <em>Route</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getRoutingSlip <em>Routing Slip</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getSample <em>Sample</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getSetBody <em>Set Body</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getSetExchangePattern <em>Set Exchange Pattern</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getSetFaultBody <em>Set Fault Body</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getSetHeader <em>Set Header</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getSetOutHeader <em>Set Out Header</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getSetProperty <em>Set Property</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getSort <em>Sort</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getSplit <em>Split</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getStop <em>Stop</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getThreads <em>Threads</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getThrottle <em>Throttle</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getThrowException <em>Throw Exception</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getTo <em>To</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getTransacted <em>Transacted</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getTransform <em>Transform</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getDoTry <em>Do Try</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getUnmarshal <em>Unmarshal</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getValidate <em>Validate</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getWireTap <em>Wire Tap</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getAutoStartup <em>Auto Startup</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getDelayer <em>Delayer</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getErrorHandlerRef <em>Error Handler Ref</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getGroup1 <em>Group1</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getHandleFault <em>Handle Fault</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getRoutePolicyRef <em>Route Policy Ref</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getShutdownRoute <em>Shutdown Route</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getShutdownRunningTask <em>Shutdown Running Task</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getStartupOrder <em>Startup Order</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getStreamCache <em>Stream Cache</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getTrace <em>Trace</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.RouteDefinitionImpl#getAnyAttribute1 <em>Any Attribute1</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
