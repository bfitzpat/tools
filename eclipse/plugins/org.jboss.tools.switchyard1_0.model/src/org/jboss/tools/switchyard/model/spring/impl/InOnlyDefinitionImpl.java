...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>In Only Definition</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.InOnlyDefinitionImpl#getAnyAttribute3 <em>Any Attribute3</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class InOnlyDefinitionImpl extends SendDefinitionImpl implements InOnlyDefinition {
	/**
	 ...
	 * @generated
	 */
	protected InOnlyDefinitionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SpringPackage.eINSTANCE.getInOnlyDefinition();
	}
	...
	public FeatureMap getAnyAttribute3() {
		if (anyAttribute3 == null) {
			anyAttribute3 = new BasicFeatureMap(this, SpringPackage.IN_ONLY_DEFINITION__ANY_ATTRIBUTE3);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SpringPackage.IN_ONLY_DEFINITION__ANY_ATTRIBUTE3:
