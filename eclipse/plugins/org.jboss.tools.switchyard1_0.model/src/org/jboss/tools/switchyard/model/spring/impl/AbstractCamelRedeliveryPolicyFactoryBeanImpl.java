...
import org.jboss.tools.switchyard.model.spring.AbstractCamelRedeliveryPolicyFactoryBean;
 ...
 * <ul>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.AbstractCamelRedeliveryPolicyFactoryBeanImpl#getAsyncDelayedRedelivery <em>Async Delayed Redelivery</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.AbstractCamelRedeliveryPolicyFactoryBeanImpl#getBackOffMultiplier <em>Back Off Multiplier</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.AbstractCamelRedeliveryPolicyFactoryBeanImpl#getCollisionAvoidanceFactor <em>Collision Avoidance Factor</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.AbstractCamelRedeliveryPolicyFactoryBeanImpl#getDelayPattern <em>Delay Pattern</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.AbstractCamelRedeliveryPolicyFactoryBeanImpl#getDisableRedelivery <em>Disable Redelivery</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.AbstractCamelRedeliveryPolicyFactoryBeanImpl#getLogContinued <em>Log Continued</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.AbstractCamelRedeliveryPolicyFactoryBeanImpl#getLogExhausted <em>Log Exhausted</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.AbstractCamelRedeliveryPolicyFactoryBeanImpl#getLogHandled <em>Log Handled</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.AbstractCamelRedeliveryPolicyFactoryBeanImpl#getLogRetryAttempted <em>Log Retry Attempted</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.AbstractCamelRedeliveryPolicyFactoryBeanImpl#getLogRetryStackTrace <em>Log Retry Stack Trace</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.AbstractCamelRedeliveryPolicyFactoryBeanImpl#getLogStackTrace <em>Log Stack Trace</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.AbstractCamelRedeliveryPolicyFactoryBeanImpl#getMaximumRedeliveries <em>Maximum Redeliveries</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.AbstractCamelRedeliveryPolicyFactoryBeanImpl#getMaximumRedeliveryDelay <em>Maximum Redelivery Delay</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.AbstractCamelRedeliveryPolicyFactoryBeanImpl#getRedeliveryDelay <em>Redelivery Delay</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.AbstractCamelRedeliveryPolicyFactoryBeanImpl#getRetriesExhaustedLogLevel <em>Retries Exhausted Log Level</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.AbstractCamelRedeliveryPolicyFactoryBeanImpl#getRetryAttemptedLogLevel <em>Retry Attempted Log Level</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.AbstractCamelRedeliveryPolicyFactoryBeanImpl#getUseCollisionAvoidance <em>Use Collision Avoidance</em>}</li>
 *   <li>{@link org.jboss.tools.switchyard.model.spring.impl.AbstractCamelRedeliveryPolicyFactoryBeanImpl#getUseExponentialBackOff <em>Use Exponential Back Off</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
