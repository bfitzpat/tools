 ...
 * 
 */
public class CamelRSSConsumerComposite extends AbstractSYBindingComposite  {
    ...
    public void setBinding(Binding impl) {
        ...
        if (impl instanceof CamelRSSBindingType) {
            _binding = (CamelRSSBindingType) impl;
    ...
    private void bindControls(final DataBindingContext context) {
        ...
        org.eclipse.core.databinding.Binding binding = context.bindValue(
                ...
                new EMFUpdateValueStrategyNullForEmptyString(null, UpdateValueStrategy.POLICY_CONVERT)
                        .setAfterConvertValidator(new StringEmptyValidator(
                                "RSS binding name should not be empty", Status.WARNING)), null);
        ...
        binding = context.bindValue(SWTObservables.observeText(_nameText, new int[] {SWT.Modify }), ObservablesUtil
                ...
                new EMFUpdateValueStrategyNullForEmptyString(null, UpdateValueStrategy.POLICY_CONVERT)
                        .setAfterConvertValidator(new StringEmptyValidator(
                                "RSS binding name should not be empty", Status.WARNING)), new UpdateValueStrategy(
        ...
        FeaturePath path = FeaturePath.fromList(
                RssPackage.Literals.CAMEL_RSS_BINDING_TYPE__CONSUME,
