...
public class ScaValidator extends EObjectValidator {
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
		switch (classifierID) {
			...
			case ScaPackage.EXTENDABLE_TYPE:
				return validateExtendableType((ExtendableType)value, diagnostics, context);
	 ...
	 * @generated
	 */
    public boolean validateExtendableType(ExtendableType extendableType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(extendableType, diagnostics, context);
	}
