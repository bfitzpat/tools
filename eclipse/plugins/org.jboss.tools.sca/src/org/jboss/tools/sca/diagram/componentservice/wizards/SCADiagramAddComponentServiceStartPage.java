...
public class SCADiagramAddComponentServiceStartPage extends BaseWizardPage {
    ...
    private Text _componentServiceNameText;
    private String _componentServiceName = null;
    ...
    public void createControl(Composite parent) {
        ...
        _componentServiceNameText = new Text(composite, SWT.BORDER);
        _componentServiceNameText.addModifyListener(new ModifyListener() {
            public void modifyText(ModifyEvent e) {
                handleModify();
            }
        });

        _componentServiceNameText.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
    ...
    public String getComponentServiceName() {
        return this._componentServiceName;
    }
    ...
    private void handleModify() {
        _componentServiceName = _componentServiceNameText.getText().trim();
        validate();
    }

    private void validate() {
        String errorMessage = null;
        String cpName = _componentServiceNameText.getText();
