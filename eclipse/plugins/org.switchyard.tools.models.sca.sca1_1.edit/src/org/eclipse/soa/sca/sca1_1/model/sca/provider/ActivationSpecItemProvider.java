...
/**
 * This is the item provider adapter for a {@link org.eclipse.soa.sca.sca1_1.model.sca.ActivationSpec} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivationSpecItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ScaPackage.eINSTANCE.getActivationSpec_Create(),
				 true,
				 false,
				 false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ActivationSpec_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ActivationSpec_name_feature", "_UI_ActivationSpec_type"),
				 ScaPackage.eINSTANCE.getActivationSpec_Name(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ScaPackage.eINSTANCE.getActivationSpec_Type(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScaPackage.eINSTANCE.getActivationSpec_Property());
			childrenFeatures.add(ScaPackage.eINSTANCE.getActivationSpec_Any());
			childrenFeatures.add(ScaPackage.eINSTANCE.getActivationSpec_AnyAttribute());
		}
	...
	/**
	 * This returns ActivationSpec.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ActivationSpec"));
	}
	...
	public String getText(Object object) {
		String label = ((ActivationSpec)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ScaPackage.eINSTANCE.getActivationSpec_Property(),
