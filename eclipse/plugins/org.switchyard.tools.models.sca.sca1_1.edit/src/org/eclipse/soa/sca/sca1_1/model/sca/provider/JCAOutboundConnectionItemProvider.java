...
/**
 * This is the item provider adapter for a {@link org.eclipse.soa.sca.sca1_1.model.sca.JCAOutboundConnection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JCAOutboundConnectionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ScaPackage.eINSTANCE.getJCAOutboundConnection_ResAuth(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ScaPackage.eINSTANCE.getJCAOutboundConnection_Managed(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScaPackage.eINSTANCE.getJCAOutboundConnection_ResourceAdapter());
			childrenFeatures.add(ScaPackage.eINSTANCE.getJCAOutboundConnection_Connection());
			childrenFeatures.add(ScaPackage.eINSTANCE.getJCAOutboundConnection_Any());
			childrenFeatures.add(ScaPackage.eINSTANCE.getJCAOutboundConnection_AnyAttribute());
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(JCAOutboundConnection.class)) {
			case ScaPackage.JCA_OUTBOUND_CONNECTION__RES_AUTH:
			case ScaPackage.JCA_OUTBOUND_CONNECTION__MANAGED:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case ScaPackage.JCA_OUTBOUND_CONNECTION__RESOURCE_ADAPTER:
			case ScaPackage.JCA_OUTBOUND_CONNECTION__CONNECTION:
			case ScaPackage.JCA_OUTBOUND_CONNECTION__ANY:
			case ScaPackage.JCA_OUTBOUND_CONNECTION__ANY_ATTRIBUTE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ScaPackage.eINSTANCE.getJCAOutboundConnection_ResourceAdapter(),
				 ScaFactory.eINSTANCE.createResourceAdapter()));

		newChildDescriptors.add
			(createChildParameter
				(ScaPackage.eINSTANCE.getJCAOutboundConnection_Connection(),
