...
/**
 * This is the item provider adapter for a {@link org.eclipse.soa.sca.sca1_1.model.sca.ConnectionSpec} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectionSpecItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ScaPackage.eINSTANCE.getConnectionSpec_Type(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScaPackage.eINSTANCE.getConnectionSpec_Property());
			childrenFeatures.add(ScaPackage.eINSTANCE.getConnectionSpec_Any());
			childrenFeatures.add(ScaPackage.eINSTANCE.getConnectionSpec_AnyAttribute());
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConnectionSpec.class)) {
			case ScaPackage.CONNECTION_SPEC__TYPE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case ScaPackage.CONNECTION_SPEC__PROPERTY:
			case ScaPackage.CONNECTION_SPEC__ANY:
			case ScaPackage.CONNECTION_SPEC__ANY_ATTRIBUTE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ScaPackage.eINSTANCE.getConnectionSpec_Property(),
