...
/**
 * This is the item provider adapter for a {@link org.eclipse.soa.sca.sca1_1.model.sca.InteractionSpec} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InteractionSpecItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ScaPackage.eINSTANCE.getInteractionSpec_Type(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScaPackage.eINSTANCE.getInteractionSpec_Property());
			childrenFeatures.add(ScaPackage.eINSTANCE.getInteractionSpec_Any());
			childrenFeatures.add(ScaPackage.eINSTANCE.getInteractionSpec_AnyAttribute());
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InteractionSpec.class)) {
			case ScaPackage.INTERACTION_SPEC__TYPE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case ScaPackage.INTERACTION_SPEC__PROPERTY:
			case ScaPackage.INTERACTION_SPEC__ANY:
			case ScaPackage.INTERACTION_SPEC__ANY_ATTRIBUTE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ScaPackage.eINSTANCE.getInteractionSpec_Property(),
