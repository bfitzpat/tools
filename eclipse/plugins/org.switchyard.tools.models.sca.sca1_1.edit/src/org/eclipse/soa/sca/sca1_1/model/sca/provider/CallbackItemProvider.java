...
/**
 * This is the item provider adapter for a {@link org.eclipse.soa.sca.sca1_1.model.sca.Callback} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CallbackItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Callback_policySets_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Callback_policySets_feature", "_UI_Callback_type"),
				 ScaPackage.eINSTANCE.getCallback_PolicySets(),
				 true,
				 false,
				 false,
	...
	protected void addRequiresPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Callback_requires_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Callback_requires_feature", "_UI_Callback_type"),
				 ScaPackage.eINSTANCE.getCallback_Requires(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScaPackage.eINSTANCE.getCallback_Group());
		}
	...
	public String getText(Object object) {
		List labelValue = ((Callback)object).getPolicySets();
